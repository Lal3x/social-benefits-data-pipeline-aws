"""
Glue Job (PySpark) — camada de transformação.
...
e sem MSCK manual. Assim o Athena (DDL do Athena) já enxerga os dados.
...
DDL do Athena) — o job só ADICIONA partições, herdando o schema da tabela.
...
# 6) CATALOGA: registra as partições escritas no Data Catalog (catálogo).
